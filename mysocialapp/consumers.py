...
#---I WROTE THIS CODE---
    ...
    def get_chat_history(self):
        return ChatMessage.objects.filter(room_name=self.room_name).order_by('timestamp')
        ...
        history_data = [
            {
                ...
                'timestamp': message.timestamp.astimezone(timezone.get_current_timezone()).strftime('%d-%m-%Y %H:%M'),
            }
